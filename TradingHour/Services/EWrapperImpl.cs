...
namespace TradingHour
{
    //! [ewrapperimpl]
    public class EWrapperImpl : EWrapper, IIBMessageResponse, IIBErrorHandler
    {
        //! [ewrapperimpl]
        ...
        public event HandleMessageResponse OnMessageResponse;
        ...
        public virtual void contractDetails(int reqId, ContractDetails contractDetails)
        {
            ...
            {
                OnMessageResponse?.Invoke(contractDetails, reqId);
            }
        }
